...
class ComentariosPageEvento extends StatefulWidget {
  final Evento evento;

  ComentariosPageEvento({required this.evento});

  @override
  _ComentariosPageEventoState createState() => _ComentariosPageEventoState();
}

class _ComentariosPageEventoState extends State<ComentariosPageEvento> {
